...
<head>
    ...
    <meta name="description" content="Página de búsqueda del sitio web RealTickets, encargada de mostrar todos los eventos relacionados a un resultado de búsqueda.">

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet"
        crossorigin="anonymous">
        <link rel="stylesheet" href="./css/style.min.css">

    <title>RealTickets - Búsqueda</title>
</head>

<body>
    <div class="container-fluid">
        <div class="row eventos-header-section">
            <div class="col">
                <!-- NAV -->
                ...
                <header>
                    ...
                    <!-- BÚSQUEDA -->
                    <p class="breadcrumbs">Inicio / Resultado de búsqueda</p>
                    <h1 class="tittle-line">"Frase consultada"</h1>
                </header>
            </div>
        </div>

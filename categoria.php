...
<head>
    ...
    <meta name="description" content="Página de categoría del sitio web RealTickets, encargada de mostrar todos los eventos disponibles de una categoría específica.">

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet"
        crossorigin="anonymous">
        <link rel="stylesheet" href="./css/style.min.css">

    <title>RealTickets - Categoría</title>
</head>

<body>
    <div class="container-fluid">
        <div class="row categoria-header-section">
            <div class="col">
                <!-- NAV -->
                ...
                <header>
                    ...
                    <!-- BÚSQUEDA -->
                    <p class="breadcrumbs">Inicio / Eventos</p>
                    <h1 class="tittle-line">Categoría</h1>
                </header>
            </div>
        </div>

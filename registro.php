...
<head>
    ...
    <meta name="description" content="Página de registro del sitio web RealTickets, encargada de mostrar las opciones de registro de un evento específico.">
            ...
            <div class="evento-header-opacity">
                <div class="col">
                    ...
                    <nav class="nav fixed-top">
                        <!-- BACK -->
                        <a class="back-icon-display" href="./evento.php"><img class="menu-mobile" src="./imgs/vectores/Back.svg"
                                alt="Botón atrás"></a>
                        <!-- BACK -->

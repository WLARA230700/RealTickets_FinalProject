        ...
        <div class="row header-section">
            <div class="col">
                ...
                <nav class="nav fixed-top">
                    ...
                    <!-- MENU MOBILE -->
                    <p id="realtickets">RealTickets</p>
                    <ul class="nav-list">
                        <li class="nav-item"><a href="#" class="nav-link">Eventos</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Académico</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Arte</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Cinema</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Conciertos</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Fiestas</a></li>
                        <li class="nav-item"><a href="#" class="nav-link">Teatro</a></li>
                    </ul>
                </nav>
                <!-- NAV -->
                <!-- HEADER -->
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="row btn-vermas-agregado-bg margin-0">
                            <a class="btn-vermas-evento" href="#">
                                <span>Ver más</span>

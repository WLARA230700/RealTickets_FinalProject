...
<head>
    ...
    <meta name="description" content="Página de confirmación del sitio web RealTickets, encargada de mostrar las opciones para confirmar el registro del evento.">

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet"
        crossorigin="anonymous">
    <link rel="stylesheet" href="./css/style.min.css">

    <title>RealTickets - Confirmar</title>
</head>
    ...
    <div class="container-fluid">
            ...
            <div class="evento-header-opacity">
                <div class="col">
                    ...
                    <nav class="nav fixed-top">
                        <!-- BACK -->
                        <a class="back-icon-display" href="./registro.php"><img class="menu-mobile" src="./imgs/vectores/Back.svg"
                                alt="Botón atrás"></a>
                        <!-- BACK -->
                    ...
                    <header>
                        ...
                        <!-- BÚSQUEDA -->
                        <p class="breadcrumbs">Inicio / ... / Categoría / Evento / Registro</p>
                        <h1 class="tittle-line">Confirmación</h1>
                    </header>
                </div>
            </div>
        ...
        <div class="row background-eventos">
            ...
            <div class="row margin-0">
                <div class="col-12">
                    <label class="confirmar-label" for="nombre">Nombre Completo</label>
                    <input class="confirmar-input" type="text" name="nombre" id="nombre" placeholder="Nombre Completo">

                    <label class="confirmar-label" for="email">Correo Electrónico</label>
                    <input class="confirmar-input" type="email" name="email" id="email"
                        placeholder="Correo Electrónico">

                    <a class="evento-btn-registrarse" href="./resumen.php">Confirmar</a>
                </div>
            </div>
            <!-- CONFIRMACION -->
        </div>

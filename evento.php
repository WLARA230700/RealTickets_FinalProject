...
<body>
    <div class="container-fluid">
        ...
        <div class="row background-eventos">
            ...
            <div class="row margin-0">
                <div class="col-12">
                    <p class="evento-info">Descripción:  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Descripción: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
            <div class="row margin-0">
                <div class="col-6">
                ...
                <div class="col-6">
                    <a class="evento-btn-registrarse" href="evento-registrarse">Registrarse</a>
                </div>
            </div>
            <!-- INFO EVENTO -->
            <!-- EVENTOS -->

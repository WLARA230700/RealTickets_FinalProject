...
<head>
    ...
    <meta name="description" content="Página de eventos del sitio web RealTickets, encargada de mostrar todos los eventos disponibles.">

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet"
        crossorigin="anonymous">
    <link rel="stylesheet" href="./css/style.css">

    <title>RealTickets - Eventos</title>
</head>
        ...
        <div class="row eventos-header-section">
            <div class="col">
                ...
                <header>
                    ...
                    <h1 class="tittle-line">Eventos</h1>
                </header>
            </div>
        </div>
